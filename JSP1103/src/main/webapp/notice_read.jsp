  ...
  <script>
  		$(function(){
  			$("#modifyBtn").click(function(){
  				...
  				var bcont = $(".article").text();
  				var bdate = $("#bdate").text();
  				location.href = "notice_modify.jsp?btitle="+btitle+"&bdate="+bdate+"&bcont="+bcont;
  				//location.href = "notice_modify.jsp?btitle=게시글 내용&bdate="+bdate;
  			});
  		});
  </script>
</head>
...
<body>
  ...
  <section>
    ...
    <table>
      ...
      <tr>
        <td class="article">이미지 내용은 키즈잼 2020년 변경사항 안내입니다. 
