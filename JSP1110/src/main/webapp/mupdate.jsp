		   ...
		   <table>
		     ...
		     <tr>
		       ...
		       <td>
		         ...
		         <%if(mdto.getGender().equals("Male")) out.println("checked");%>>
		         <label for="Male">남자</label>
		         <input type="radio" name="gender" id="Female" value="Female"
		         <%if(mdto.getGender().equals("Female")) out.println("checked");%>>
		     ...
		     <tr>
		       ...
		       <td>
		         ...
		         <%if(mdto.getHobby().contains("golf")) out.println("checked");%>>
		         <label for="golf">골프</label>
		         <input type="checkbox" name="hobby" id="run" value="run"
		         <%if(mdto.getHobby().contains("run")) out.println("checked");%>>
		         <label for="run">조깅</label>
		         <input type="checkbox" name="hobby" id="cook" value="cook"
		         <%if(mdto.getHobby().contains("cook")) out.println("checked");%>>
		         <label for="cook">요리</label>
		         <input type="checkbox" name="hobby" id="book" value="book"
		         <%if(mdto.getHobby().contains("book")) out.println("checked");%>>
