...
<html>
	<head>
		...
		*{margin:0; padding:0;}
			...
			table,th,td{border:1px solid black; border_collapse: collapse; font-size:16px;}
			form, table{width:800px; margin:30px auto;}
			th,td{width:200px; height:40px;}
			button{display:block; width:100px; height:50px; margin:0 auto;}
			.pop{width:400px; height:424px; background:url("images/popup.jpg") no-repeat;
			background-size:75%; position: fixed; left:50%; display:none;}
			.on{display:block;}
