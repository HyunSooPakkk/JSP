		...
		<form name="m_frm" method="post" action="doM_info_update.do" >
			...
			<tbody>
				<tr>
					...
					<td style="font-family: 'JeonjuCraftGoR' !important;"></td>
				</tr>
				<tr>
				...
				<ul>
					...
					<li><input type="text" id="mail_id" name="mail_id" selected="" required /></li>
					<li><span>@</span></li>
					<li><input type="text" id="mail_tail" name="mail_tail" selected="" required /></li>
					<select id="emailList">
				...
				<ul class="pta">
					...
					<input type="text" class="zonecode w134" id="zonecode" name="zonecode" >&nbsp;
					</li>
					<li><a class="addressBtn" style=cursor:pointer;><span style="font-family: 'JeonjuCraftGoR' !important;">우편번호 찾기</span></a></li>
					<li class="pt5"><input type="text" class="addressType" id="addressType" name="addressType" /></li>
