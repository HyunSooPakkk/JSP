			...
			<div id="contents">
				<div id="customer">
					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<c:forEach items="${list }" var="ndto" >
								<tr>
									<td class="tnone">${ndto.boardid }</td>
									<td class="tnone">${ndto.hit }</td>
										<td><a href="teamNoticeView.jsp">${ndto.title }</a></td>
									<td>${ndto.memberid }</td>
									<td><frm:formatDate value="${ndto.createdate }" pattern="yyyy-MM-dd"/></td>
								</tr>
							</c:forEach>
					...
					<div class="btnAreaList">
						...
						<div class="bwright">
							<ul>
								<li><a href="teamNoticeWrite.do" class="writeBtn">글쓰기</a></li>
							</ul>
						</div>
