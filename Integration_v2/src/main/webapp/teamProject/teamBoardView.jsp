...
$(function(){
	$("#boardDelete").click(function(){
		if(confirm("게시글을 삭제하시겠습니까?")){
			location.href="bDelete.do?boardid=${bdto.boardid}";
		}
	})
})
</script>
				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								<p class="txt">작성일 :  <fmt:formatDate value="${bdto.createdate }" pattern="yyyy-MM-dd"/></p>
							</div>
						</div>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								...
								<li><a href="#" class="sbtnMini mw" id="boardDelete">삭제</a></li>
								<li><a href="teamBoard.do" class="sbtnMini mw">목록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
