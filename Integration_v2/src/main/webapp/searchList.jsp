...
<script>
	$(function(){
		...
		$(".plusBtn>div").click(function(){
			...
			location.href="./searchList.do?sort=${sort}&start=${start}&end=${end+4}&query=${query}";
...
<div id="store-search-wrap">
	<section id="search-tab-all" class="container-lnb" style="width:700px;" >
		<form class="searchFrm" action="SearchQuery.do">
...
<div class="store-sort-btn-wrap">
	...
	<div class="sort-dropdown">
	 ...
	 <ul class="dropdown-menu">
       <li><a href="./searchList.do?sort=rate&query=${query}" data-value="rate">평점순</a></li>
      <li><a href="./searchList.do?sort=nameAsc&query=${query}" data-value="nameAsc">가나다순</a></li>
      <li><a href="./searchList.do?sort=createdDateDesc&query=${query}" data-value="createdDateDesc">최신순</a></li>
    </ul>
	</div>
</div>
</div>
...
<c:forEach begin="${start-1 }" end="${end-1 }" step="1" varStatus="status" >
