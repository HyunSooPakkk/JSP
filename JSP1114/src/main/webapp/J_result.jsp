...
<html>
	<head>
		...
		<style>
			...
			span:after{color: gray; content:","}
		</style>
	</head>
	<body>
		<h2>세션:<%=session.getAttribute("session_nickname")%></h2>
		...
		<hr>
		<h2>세션1: ${sessionScope.session_nickname}</h2>
		<h2>세션2: ${session_nickname}</h2>
		...
		<h2>아이디: ${param.id}</h2>
		<h2>이름: ${param.name}</h2>
		<h2>결과값3: ${param.num1+param.num2}</h2>
		</form>
	</body>
</html>